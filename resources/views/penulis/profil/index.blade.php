...
@section('title', 'Razen Blog | Penulis | Profil')
...
@section('content')
        ...
        <div class="col-12 col-md-7">
            ...
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                <ul class="breadcrumb pt-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('razen-blog.penulis.profil.index') }}">Profil</a></li>
                </ul>
            </nav>
        </div>
        <!-- Title End -->
    ...
    <div class="row">
        <div class="col-md-6 col-12">
            <div class="card mb-3">
                <div class="card-body">
                    <form action="{{ route('razen-blog.penulis.profil.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                        ...
                        <div class="row">
                            <div class="col-12">
                                ...
                                <div class="mb-3 position-relative form-group">
                                    ...
                                    <input type="file" class="dropify" name="foto" data-height="300" data-allowed-file-extensions="png jpg jpeg webp" data-default-file="{{ asset('images/razen-blog/foto/'.$profil->foto) }}" data-show-errors="true" required>
                                </div>
                            </div>
                        </div>
                    </form>
        ...
        <div class="col-md-6 col-12">
            <div class="card mb-3">
                <div class="card-body">
                    <form action="{{ route('razen-blog.penulis.profil.ubah_password') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row mb-3">
                            <div class="col-6" style="justify-content: center; align-self: center;">
                                <label for="" class="small-title">Ubah Password</label>
                            </div>
                            <div class="col-6" style="text-align: right">
                                <button class="btn btn-outline-primary waves-effect waves-light">Simpan Perubahan</button>
                            </div>
    ...
    <div class="card">
        <div class="card-body">
            ...
            @if ($pivot_penulis_media_sosial['status'] == 'ada')
                <form id="edit_media_sosial_profil_form" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        @php
                            $a = 1;
                        @endphp
                        @foreach ($pivot_penulis_media_sosial['pivot'] as $item)
    ...
    <script>
        ...
        $('#edit_media_sosial_profil_form').submit(function(e){
            ...
            return new swal({
                ...
                {
                    $.ajax({
                        url: "{{ route('razen-blog.penulis.profil.edit-media-sosial-profil') }}",
                        method: "POST",
                        data: {
                            "_token": "{{ csrf_token() }}",
                            ...
                            if(data.success)
                            {
                                new swal({
                                    ...
                                    title: data.success
                                        ...
                                        window.location.href = "{{ route('razen-blog.penulis.profil.index') }}";
                                });
                            }
                        }
                    });
        ...
        $('#tambah_media_sosial_profil_form').submit(function(e){
            e.preventDefault();
            $.ajax({
                url: "{{ route('razen-blog.penulis.profil.tambah-media-sosial-profil') }}",
                method: "POST",
