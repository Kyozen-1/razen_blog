...
@section('title', 'Razen Blog | Konten | Create')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Razen Blog | Konten | Create</h1>
    ...
    <form action="{{ route('razen-blog.admin.konten.store') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
        @csrf
        <div class="card mb-3">
            <div class="card-body">
                <div class="row">
