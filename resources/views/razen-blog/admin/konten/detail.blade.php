...
@section('title', 'Razen Blog | Konten | Detail')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Razen Blog | Konten | Detail</h1>
    ...
    <div class="row mb-3">
        <div class="col-12" style="text-align:right">
            <a class="btn btn-outline-primary waves-effect waves-light mr-2 item_create" title="Kembali" href="{{ route('razen-blog.admin.konten.index') }}"><i class="fas fa-arrow-left"></i></a>
        </div>
    </div>
                                    ...
                                    <div class="col position-static">
                                        <div class="card-body d-flex flex-column pt-0 pb-0 h-100 justify-content-center">
                                            <div class="d-flex flex-column">
                                                <a href="{{ route('razen-blog.admin.konten.detail', ['id'=>$konten_terkait->id]) }}" class="stretched-link body-link">
