...
@section('title', 'Razen Blog | Landing Page | Berita')
...
@section('content')
    ...
    <div class="page-title-container">
        ...
        <div class="col-12 col-md-7">
            <h1 class="mb-0 pb-0 display-4" id="title">Berita</h1>
            <nav class="breadcrumb-container d-inline-block" aria-label="breadcrumb">
                <ul class="breadcrumb pt-0">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('razen-blog.landing-page.berita.index') }}">Berita</a></li>
                </ul>
            </nav>
        </div>
        <!-- Title End -->
        ...
        <div class="card-body">
            <div class="row mb-3">
                ...
                <div class="col-6 mb-3" style="text-align: right;">
                    <a href="{{ route('berita') }}#page-padding-hero" class="btn btn-icon waves-effect waves-light btn-secondary" target="blank"><i class="fas fa-pager"></i> Preview</a>
                </div>
                <div class="col-12">
                    <img src="{{ asset('images/landing-page/berita/section_1.png') }}" alt="" class="img-fluid rounded">
                </div>
            </div>
            {{-- Form Start --}}

            <form action="{{ route('razen-blog.landing-page.berita.store.section-1') }}" novalidate="novalidate" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="mb-3 position-relative form-group">
                            ...
                            @if ($section_1)
                            <input type="file" class="dropify" name="gambar_background" data-height="300" data-allowed-file-extensions="png jpg jpeg" data-show-errors="true" data-default-file="{{ asset('images/landing-page/berita/'.$section_1['gambar_background']) }}" required>
                            @else
